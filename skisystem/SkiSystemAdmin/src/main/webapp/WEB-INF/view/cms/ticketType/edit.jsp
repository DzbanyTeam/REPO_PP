...
<div class="container py-5">
    <div class="row">
        <div class="col-lg-6 offset-lg-3">
            ...
            <form:form method="post" class="mt-5" modelAttribute="ticketType" action="/admin/ticket-types/submit">
                ...
                <div class="form-group">
                    ...
                    <spring:bind path="numberOfHours">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text">h</div>
                            </div>
                            <form:input class="form-control ${status.error ? 'is-invalid' : ''}" path="numberOfHours"/>
                        </div>
                    </spring:bind>
                    <form:errors path="numberOfHours" class="invalid-feedback" />
                </div>
                <div class="form-group">
                    <label>Opis</label>
                ...
                <div class="text-right">
                    <a href="<spring:url value="/admin/ticket-types"/>" class="btn btn-light">Wróć</a>&ensp;
