...
<head>
    <meta charset="utf-8">
    <c:if test="${dayOfTheWeek.id != null}">
        <title>SkiSystem - panel administracyjny - edycja dnia tygodnia ${dayOfTheWeek.name}</title>
    </c:if>
    <c:if test="${dayOfTheWeek.id == null}">
        <title>SkiSystem - panel administracyjny - dodawanie dnia tygodnia</title>
    </c:if>
...
<div class="container py-5">
    <div class="row">
        <div class="col-lg-6 offset-lg-3">
            <a class="btn btn-lg btn-light float-left mr-3" href="<spring:url value="/admin/days-of-the-week"/>"><i class="fas fa-arrow-left"></i></a>

            <c:if test="${dayOfTheWeek.id != null}">
                <h1 id="header">Edycja dnia tygodnia ${dayOfTheWeek.name}</h1>
            </c:if>
            <c:if test="${dayOfTheWeek.id == null}">
                <h1 id="header">Dodawanie dnia tygodnia</h1>
            </c:if>

            <form:form method="post" class="mt-5" modelAttribute="dayOfTheWeek" action="/admin/days-of-the-week/submit">
                ...
                <div class="text-right">
                    <a href="<spring:url value="/admin/days-of-the-week"/>" class="btn btn-light">Wróć</a>&ensp;
