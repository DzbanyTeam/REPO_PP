...
<head>
    ...
    <c:if test="${admin.id != 0}">
        <title>SkiProject - panel administracyjny - edycja administratora ${admin.username}</title>
    </c:if>
    <c:if test="${admin.id == 0}">
        <title>SkiProject - panel administracyjny - dodawanie administratora</title>
    </c:if>
